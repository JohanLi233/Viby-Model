...
def init_worker_tokenizer():
    ...
    try:
        WORKER_TOKENIZER = AutoTokenizer.from_pretrained("model/")
        return True
...
class OptimizedTextProcessor:
    ...
    def __init__(self, batch_size: int = 1000, buffer_size: int = 10000, num_workers: Optional[int] = None):
        """
